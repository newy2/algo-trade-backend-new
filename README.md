...
<img src="doc/mapping_strategy_00.png" />  
...
개발용 DB의 데이터는 `local-infra/db/mysql/data`, `local-infra/db/postgres/data` 폴더에 저장된다.
...
개발 테스트 데이터 생성 스크립트는 `task/src/main/resources/ddl/liquibase/020-init-data` 폴더에서 확인한다.
